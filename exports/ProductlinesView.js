	...
	async export(records, req, res) {
		try{
			...
			let columns =  [
				...
				{header: "Textdescription", key: "textdescription"},
				{header: "Htmldescription", key: "htmldescription"},
				{header: "Image", key: "image"}
			]
			let filename = utils.dateNow() + "productlinesview-report";
			if(format == "excel"){
